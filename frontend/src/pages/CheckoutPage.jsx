  ...
  const handleOrder = async () => {
    ...
    try {
      ...
      const options = {
        ...
        prefill: { name: address.name, email: "customer@example.com", contact: address.phone },
        theme: { color: "#FBBF24" },
      };
    ...
    <div className="min-h-screen bg-gray-100 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-3xl shadow-lg">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input
                  ...
                  value={address.name}
                  onChange={handleChange}
                  className="border p-3 rounded-xl focus:ring-2 focus:ring-yellow-400 outline-none w-full"
                />
                <input
                  type="text"
                  name="phone"
                ...
                <input
                  ...
                  value={address.street}
                  onChange={handleChange}
                  className="border p-3 rounded-xl focus:ring-2 focus:ring-yellow-400 outline-none w-full sm:col-span-2"
                />
                <input
                  type="text"
                  name="city"
          ...
          {/* Order Summary */}
          <div className="bg-white p-6 rounded-3xl shadow-lg flex flex-col justify-between">
            ...
            <button
              className="mt-6 w-full bg-yellow-500 hover:bg-yellow-600 text-white py-3 rounded-2xl font-semibold text-lg shadow-md hover:shadow-lg transition"
              onClick={handleOrder}
            >
              Place Order
            </button>
