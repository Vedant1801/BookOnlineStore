    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Image Upload */}
          <div>
            <label className="block text-gray-700 font-medium">Upload Book Image:</label>
            <input
              type="file"
              accept="image/*"
          ...
          <div className="text-center">
            <button
              type="submit"
              className="px-4 py-2 bg-[#3AAFA9] text-white rounded-md hover:bg-[#2E8C87] w-full transition"
            >
              Add Book
            </button>
          </div>
